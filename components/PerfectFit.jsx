...
const PerfectFit = () => {
  ...
  <div className="max-w-7xl mx-auto flex flex-col-reverse lg:flex-row items-center lg:items-start gap-8 lg:gap-12">
    {/* Left Section */}
    <div className="w-full lg:w-1/2 pt-6 sm:pt-10 lg:pt-[10vh] px-1 sm:px-4">
      ...
      <h1 className="text-[#002060] text-2xl sm:text-[28px] md:text-[32px] lg:text-[38px] xl:text-[42px] font-bold leading-snug mb-4 sm:mb-6">
      ...
      <ul className="space-y-3">
        {[
          ...
          <li key={idx} className="flex items-start gap-2">
            ...
            />
            <span className="text-gray-800 text-[14px] sm:text-[15px] leading-relaxed">{item}</span>
          </li>
        ))}
      </ul>
    </div>
    ...
    {/* Right Section - Image */}
    <div className="w-full lg:w-1/2 px-1 sm:px-4 text-center lg:text-left flex justify-center items-center">
      <Image
        src="/images/Who-Should-Attend.png"
        alt="Who Should Attend"
        width={600}
        height={500}
        className="w-full max-w-xs sm:max-w-md md:max-w-lg lg:max-w-xl h-auto rounded-md"
        priority
      />
    </div>
  </div>
